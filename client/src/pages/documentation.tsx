                    ...
                    <div key={stage.id} className="bg-green-50 p-3 rounded-lg border-l-4 border-green-200">
                      ...
                      {stage.completedAt && (
                        <div className="text-xs text-green-600">
                          {new Date(stage.completedAt).toLocaleDateString(language === 'en' ? 'en-US' : 'ru-RU')} в {new Date(stage.completedAt).toLocaleTimeString(language === 'en' ? 'en-US' : 'ru-RU', { hour: '2-digit', minute: '2-digit' })}
                        </div>
                      )}
                    </div>
                  )
