            ...
            <CardContent className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-sm">
                  {t('created')}: {new Date(candidate.createdAt).toLocaleDateString(language === 'ru' ? 'ru-RU' : 'en-US')}
                </span>
              </div>
              {candidate.source && (
                <div className="flex items-center space-x-3">
                  ...
                  <div className="space-y-2">
                    ...
                    {candidate.dismissalDate && (
                      <div>
                        ...
                        <p className="text-sm">{new Date(candidate.dismissalDate).toLocaleDateString(language === 'ru' ? 'ru-RU' : 'en-US')}</p>
                      </div>
                    )}
                  </div>
                </div>
                          ...
                          <div className="mt-2 space-y-1">
                            ...
                            {stage.scheduledAt && (
                              <div className="flex items-center text-sm text-gray-600">
                                ...
                                {t('scheduled')}: {new Date(stage.scheduledAt).toLocaleDateString(language === 'ru' ? 'ru-RU' : 'en-US')} {t('at')} {new Date(stage.scheduledAt).toLocaleTimeString(language === 'ru' ? 'ru-RU' : 'en-US', { hour: '2-digit', minute: '2-digit' })}
                              </div>
                            )}
                              ...
                              <div className="mt-2 p-3 bg-gray-50 rounded-lg">
                                ...
                                {stage.completedAt && editingFeedback !== stage.id && (
                                  <div className="text-xs text-gray-500 mt-1">
                                    {t('left')}: {new Date(stage.completedAt).toLocaleDateString(language === 'ru' ? 'ru-RU' : 'en-US')} {t('at')} {new Date(stage.completedAt).toLocaleTimeString(language === 'ru' ? 'ru-RU' : 'en-US', { hour: '2-digit', minute: '2-digit' })}
                                  </div>
                                )}
                              </div>
                            )}
